...
WITH ivr_data AS (
  SELECT 
    ...
    CASE 
    WHEN STARTS_WITH(ivr_calls.vdn_label, 'ATC') THEN 'FRONT'
    WHEN STARTS_WITH(ivr_calls.vdn_label, 'TECH') THEN 'TECH'
    WHEN ivr_calls.vdn_label = 'ABSORPTION' THEN 'ABSORPTION'
    ELSE 'RESTO'
